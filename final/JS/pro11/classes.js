class Ball {
    ...
    draw(I) {
        ...
        fill(map(this.x, 0, width, 150, 255), 0, map(this.y, 0, height, 150, 255), this.aplha)
        noStroke();
        ...
        if (this.fading == true) {
            for (var i = 0; i < this.linesArr.length; i++) {
                ...
                if (this.linesArr[i].linePres == false) {
                    ...
                    stroke(
                        0,
                        200 + noise(this.linesArr[i].noiseGreen) * 55,
...
class Flower {
    ...
    draw(I) {
        ...
        fill(noise(this.noiseColor) * 50, this.aplha);
        stroke(noise(this.noiseColor) * 50, this.aplha);
        strokeWeight(1);
