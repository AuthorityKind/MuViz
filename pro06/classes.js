class Ball {
    ...
    draw(I) {
        ...
        fill(map(this.x, 0, width, 0, 200), 0, map(this.y, 0, height, 150, 255), this.aplha)
        noStroke();
        ...
        if (this.fading == true) {
            for (var i = 0; i < this.linesArr.length; i++) {
                ...
                if (this.linesArr[i].linePres == false) {
                    ...
                    this.linesArr[i].noiseBlue += random(0.5, 1.5);
                    this.linesArr[i].noiseRed += random(0.05, 0.15);
                    this.linesArr[i].noiseWeight += random(0.05, 0.15);

                    stroke(
                        200 + noise(this.linesArr[i].noiseRed) * 55,
                        0,
                        200 + noise(this.linesArr[i].noiseBlue) * 55,
...
class Flower {
    ...
    draw(I) {
        ...
        this.noiseRed += random(0.005, 0.015);
        this.noiseBlue += random(0.005, 0.015);

        push()
        translate(this.x, this.y);

        fill(150 + noise(this.noiseRed) * 105, 0, noise(this.noiseBlue) * 255, this.aplha);
        stroke(150 + noise(this.noiseRed) * 105, 0, noise(this.noiseBlue) * 255, this.aplha);
        strokeWeight(1);
